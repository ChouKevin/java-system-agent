...
/**
 * 重送原始 method authority 的 stateless source segment 請求
 * contentRef 僅驗證內容一致性且不是 cache lookup key
 */
@JsonIgnoreProperties(ignoreUnknown = false)
public record GetMethodSourceSegmentRequest(
    ...
    public void rejectUnknownProperty(String property, Object value) {
        throw new IllegalArgumentException("unknown method source segment request property");
    }
}
