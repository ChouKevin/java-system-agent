...
/** 以完整 fragment identity 讀取 exact mapper XML 的封閉請求 */
@JsonIgnoreProperties(ignoreUnknown = false)
public record GetMapperFragmentRequest(
    ...
    public void rejectUnknownProperty(String property, Object value) {
        throw new IllegalArgumentException("unknown mapper fragment request property");
    }
}
