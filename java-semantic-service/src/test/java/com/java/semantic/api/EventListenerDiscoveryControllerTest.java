...
class EventListenerDiscoveryControllerTest {
    ...
    void should_return_closed_authoritative_listener_discovery_response() throws Exception {
        ...
        String body = mockMvc.perform(discoveryRequest("""
                ...
                .andExpect(jsonPath("$.candidates[0].target.sourceFile")
                        .value("src/main/java/com/example/OrderListener.java"))
                .andExpect(jsonPath("$.candidates[0].target.packageName").value("com.example"))
                .andExpect(jsonPath("$.candidates[0].target.className").value("OrderListener"))
                ...
                .andExpect(jsonPath("$.candidates[0].sourceRange.sourceFile")
                        .value("src/main/java/com/example/OrderListener.java"))
