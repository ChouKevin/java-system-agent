...
public final class GetSourceSegmentExecutor implements CapabilityExecutor<GetSourceSegmentExecutionInput> {
    ...
    public GetSourceSegmentExecutor(JavaSemanticServiceHttpAdapter adapter) { this.adapter = Objects.requireNonNull(adapter, "Java Semantic Service adapter must not be null"); }
    @Override public CapabilityExecutionResult execute(CapabilityExecutionContext context, GetSourceSegmentExecutionInput input) { return adapter.getSourceSegment(context, input); }
}
