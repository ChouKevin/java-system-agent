...
public final class DiscoverConceptsExecutor implements CapabilityExecutor<DiscoverConceptsExecutionInput> {
    ...
    public DiscoverConceptsExecutor(JavaSemanticServiceHttpAdapter adapter) { this.adapter = Objects.requireNonNull(adapter, "Java Semantic Service adapter must not be null"); }
    @Override public CapabilityExecutionResult execute(CapabilityExecutionContext context, DiscoverConceptsExecutionInput input) { return adapter.discoverConcepts(context, input); }
}
