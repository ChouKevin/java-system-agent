...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = PlanAction.class, name = "PLAN")
})
public sealed interface AgentAction permits QueryAction, AnswerAction, ClarifyAction, ExecuteAction, PlanAction {
}
