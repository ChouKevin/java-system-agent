...
1. **Outer LLM** (business analyst) uses `DocumentTools` to read service-map, business-map, and skill docs to locate the relevant repository and entry points.
...
| `read_skill_doc` | `repoId`, `groupName` | `repos/{repoId}/docs/skills/{groupName}.md` | Detailed entry points and business logic for a group |
...
- [`docs/business-map.md`](docs/business-map.md) -- Business group index
- [`java-coding-standard.md`](java-coding-standard.md) -- Full coding standard
